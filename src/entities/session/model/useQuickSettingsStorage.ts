...
export const readQuickSettingsFromStorage = (storageKey = DEFAULT_STORAGE_KEY): QuickSettings => {
  try {
...
export default function useQuickSettingsStorage(storageKey = DEFAULT_STORAGE_KEY) {
