...
const QuickSettingToggle = ({ label, description, checked, onChange, disabled = false }: QuickSettingToggleProps) => (
  <ToggleBox>
...
const LiveQuestionSection = ({ quickSettings = { question: true, sticker: true, feedback: true, unlock: true } }: { quickSettings?: QuickSettings }) => (
  <Section>
    <Title>실시간 질문</Title>
