...
/* === 각 셀 === */
const Box = styled.div<{ striped?: boolean }>`
  border: 0.1vw solid #eaeaea;
  border-radius: 0.6vw;
  display: flex;
  align-items: center;
...
const UploadBox = styled.div<{ $dragging?: boolean; $hasFile?: boolean }>`
  display: flex;
  align-items: center;
  ...
  return (
    <MainLayout>
      ...
      <CenterGrid>
        ...
        <CenterContent>
          <img src={TitleSVG} alt="발표가 달라진다" style={{ width: "95%", height: "auto" }} />
