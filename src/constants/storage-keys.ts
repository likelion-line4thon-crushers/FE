...
export const STORAGE_KEYS = {
  ROOM: 'boini_room',
  ROOM_LEGACY: 'roomData',
  AI_REPORT_ROOM: 'ai_report_room',
  AI_REPORT_ROOM_LEGACY: 'aiReportRoom',
...
export const ROOM_STORAGE_KEYS = [
  STORAGE_KEYS.AI_REPORT_ROOM,
  STORAGE_KEYS.AI_REPORT_ROOM_LEGACY,
  STORAGE_KEYS.ROOM,
  STORAGE_KEYS.ROOM_LEGACY,
] as const;
