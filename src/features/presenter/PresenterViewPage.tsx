...
import SlideViewer from "../../shared/slides/SlideViewer";
import QuestionList from "../../shared/questions/QuestionList";
import websocketService from "../../services/websocketService";
import useEmojiReactions from "../../hooks/useEmojiReactions";
import { WebSocketService } from "../../services/websocketService";
import useStickerLoader from "../../hooks/useStickerLoader";
import { useTimer } from "../../hooks/useTimer";
import { usePresenterFocusHighlight } from "../../hooks/usePresenterFocusHighlight";
...
import {
  ...
  ToggleDescription,
  ToggleInput,
} from "../../shared/settings/SettingsPanel/SettingsPanel.styles";
import styled from "styled-components";
import { AudienceCount } from "../../shared/settings/SettingsPanel";
import LiveLockButton from "../../shared/settings/SettingsPanel/LiveLockButton";
        ...
        <Section>
          ...
          <QuickTogglesGrid>
            ...
            <QuickSettingToggle
              ...
              onChange={(event: ChangeEvent<HTMLInputElement>) => handleUnlockChange(event.target.checked)}
            />
          </QuickTogglesGrid>
        </Section>
