...
export const useLiveFeedback = ({
  ...
  isEnabled,
  isPresenterWsReady,
}: { roomId?: any; currentSlide?: any; isEnabled?: any; isPresenterWsReady?: any }) => {
  ...
  const lastWebSocketUpdateRef = useRef<{ page: any; message: string; timestamp: number } | null>(null); // 웹소켓으로 받은 마지막 피드백 추적
