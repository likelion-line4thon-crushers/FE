...
import EmojiPanel from "../../../audience/components/EmojiPanel";
...
const PopularSlide = ({ roomId, deckId }: { roomId?: any; deckId?: any }) => {
  ...
  const primarySlideNumber =
    selectedData?.topSlide != null ? Number(selectedData.topSlide) : null;
            ...
            {loading ? (
              ...
              <>
                <SlideWrapper>
                  ...
                  <SlideNumber
                    slideNumber={primarySlideNumber && primarySlideNumber > 0 ? primarySlideNumber : "-"}
                    emojiCount={
